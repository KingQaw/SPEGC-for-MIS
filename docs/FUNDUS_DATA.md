...
| 测试域 | 本项目 | 论文 | 差值 | 判定 |
|---|---|---|---|---|
| A (RIM-ONE) | 28.09 | 84.90 | **−56.81** | ❌ 取景/版本问题，见下 |
| B (REFUGE) | **86.21** | 83.34 | **+2.87** | ✅ |
| C (ORIGA) | **83.02** | 84.57 | **−1.55** | ✅ |
| D (REFUGE-Test) | **81.82** | 83.54 | **−1.72** | ✅ |
| E (Drishti-GS) | 74.49 | 85.51 | **−11.02** | ⚠️ 见下 |
| 可算域平均 | 70.73 | 84.37 | −13.64 | |

**B / C / D 三域在正确口径下误差在 ±2.9 以内**，可以认为协议已对齐。
